...
const AboutText = () => {
  return (
    <Fade direction='up' fraction={0.2} triggerOnce>
      <p className='text'>
        Nǐ Háo! I&apos;m Hassan - at least that&apos;s what I was
        told. A couple of years ago in early 2016, I wrote my first
        Hello World program in a High School Computer class.
      </p>
      <p className='text'>
